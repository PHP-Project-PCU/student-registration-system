...
<head>
    ...
    <link rel="stylesheet" href="./../utils/assets/css/tailwind.output.css">
...
<body class="font-nunito text-base text-black dark:text-white dark:bg-slate-900 scroll-smooth">
    ...
    <nav id="topnav" class="defaultscroll is-sticky nav-sticky">
        <div class="container relative">
            <!-- Logo container-->
            <a class="logo flex items-center gap-2 justify-center " href="index.php">
                <div class="">
                    <img src="./../utils/assets/img/ucspyay/ucsp.png" width="60" class="inline-block dark:hidden"
                        alt="">
                    <img src="./../utils/assets/img/ucspyay/UCSPyay-logo.jpg" width="60"
                        class="hidden dark:inline-block rounded-lg" alt="">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu parent-parent-menu-item">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="https://lms.ucspyay.edu.mm" target="_blank" class="sub-menu-item">LMS
                                    Moodle</a></li>
    ...
    <section
        ...
        <div class="container relative">
            <div class="grid grid-cols-1 pb-8 text-center mt-12">
                <h3 class="mb-4 md:text-2xl text-xl md:leading-normal leading-normal font-medium text-white">( ၂၀၂၄ -
                    ၂၀၂၅ )ပညာသင်နှစ်</h3>
                            ...
                            <div class="grid lg:grid-cols-12 gap-6">
                                ...
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="roll_num" id="roll_num" type="number"
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="PaKaPaTa-" value="PaKaPaTa-">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <select id="student_nationality" name="student_fath_nationality"
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <input name="student_nrc_num" id="student_nrc_num" type="num"
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="xxxxxx">
                                </div>
                                    ...
                                    <div class="text-start">
                                        <table class="table-fixed w-full" name="examTable" id="examTable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="exam_major" name="exam_major"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                        <option>CST</option>
                                                        <option>CS</option>
                                                        <option>CT</option>
                                                ...
                                                <td>
                                                    <input name="exam_roll_num" id="exam_roll_num" type="number"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                        placeholder="">
                                                </td>
                                                <td>
                                                    <input name="exam_year" id="exam_year" type="number"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                        placeholder="">
                                                </td>
                                                <td>
                                ...
                                <div class="lg:col-span-12">
                                    <button type="button" id="addNew" name="addNew"
                                        ...
                                        onclick="addNewRow()">Add New</button>
                                </div>
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <select id="student_moth_nrc_code" name="student_moth_nrc_num_code"
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-3">
                                ...
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="gurdian_name" id="gurdian_name" type="text"
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="gurdian_relation" id="gurdian_relation" type="text"
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="gurdian_job" id="gurdian_job" type="text"
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="gurdian_address" id="gurdian_address" type="text"
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="gurdian_phone_num" type="number"
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="Phone No. :">
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <input name="passport_photo"
                                        class="form-input mt-3 w-full py-1 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        id="resumefile" type="file">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="one_inch_photo">(1" x 1") ဆိုဒ် ၁ ပုံ (၆လ အတွင်း ရိုက်ထားသောပုံ)
                                    </label>
                                    <input name="one_inch_photo"
                                        class="form-input mt-3 w-full py-1 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        id="" type="file">
                                </div>
                                <div class="lg:col-span-6">
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <input name="father_nrc_photo_front"
                                        class="form-input mt-3 w-full py-1 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        id="resumefile" type="file">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="father_nrc_photo_back">အဘမှတ်ပုံတင်(နောက်ဘက်)</label>
                                    <input name="father_nrc_photo_back"
                                        class="form-input mt-3 w-full py-1 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        id="resumefile" type="file">
                                </div>
                                <div class="lg:col-span-6">
                ...
                <div class="py-[30px] px-0">
                    <div class="grid md:grid-cols-2 items-center">
                        ...
                        <ul class="list-none footer-list md:text-end text-center mt-6 md:mt-0">
                            <li class="inline"><a href="page-job-grid.html"
                                    class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out">Jobs</a></li>
                            <li class="inline mt-[10px]"><a href="page-job-companies.html"
                                    class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out ms-2">Companies</a>
                            </li>
                            <li class="inline mt-[10px]"><a href="helpcenter-faqs.html"
                                    class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out ms-2">FAQs</a>
                            </li>
                            <li class="inline mt-[10px]"><a href="contact-one.html"
                                    class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out ms-2">Contact</a>
                            </li>
                        </ul>
                        <!--end icon-->
                    </div>
