                                ...
                                <div class="grid lg:grid-cols-12 gap-6 pt-4">
                                    ...
                                    <div class="lg:col-span-6">
                                        <div class="text-start">
                                            ...
                                            <input name="started_year" id="started_year" type="number" class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="">
                                        </div>
                                    </div>
                                    <!-- Student Information -->
                                    ...
                                    <div class="lg:col-span-6">
                                        ...
                                        <select id="student_nationality" name="student_nationality" class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    ...
                                    <div class="lg:col-span-3">
                                        ...
                                        <select id="student_moth_nrc_code" name="student_moth_nrc_code" class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                        </select>
                                    </div>
                                    <div class="lg:col-span-3">
                                    ...
                                    <div class="lg:col-span-12">
                                        <div class="text-start">
                                            <label for="scholarship">ပညာသင်ထောက်ပံ့ကြေးပေးရန်မေတ္တာရပ်ခံခြင်းပြု/မပြု</label>
                                    ...
                                    <div class="lg:col-span-6">
                                        ...
                                        <input name="fath_nrc_photo_front" id="" type="file" class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                    </div>
                                    <div class="lg:col-span-6">
                                        <label for="fath_nrc_photo_back">အဘမှတ်ပုံတင်(နောက်ဘက်)</label>
                                        <input name="fath_nrc_photo_back" id="" type="file" class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                    </div>
                                    <div class="lg:col-span-6">
                                        <label for="moth_nrc_photo_front">အမိမှတ်ပုံတင်(ရှေ့ဘက်)</label>
                                        <input name="moth_nrc_photo_front" id="" type="file" class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                    </div>
                                    <div class="lg:col-span-6">
                                        <label for="moth_nrc_photo_back">အမိမှတ်ပုံတင်(နောက်ဘက်)</label>
                                        <input name="moth_nrc_photo_back" id="" type="file" class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                    </div>
                                    <div class="lg:col-span-6">
                                    ...
                                    <div class="lg:col-span-6">
                                        ...
                                        <input name="house_registration_photo_front" id="" type="file" class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                    </div>
                                    <div class="lg:col-span-6">
                                        <label for="house_registration_photo_back">အိမ်ထောင်စုစာရင်း(နောက်ဘက်)</label>
                                        <input name="house_registration_photo_back" id="" type="file" class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                    </div>
                                    <div class="lg:col-span-6">
                                    ...
                                    <div class="lg:col-span-12">
                                        ...
                                        <button type="submit" id="registerBtn" name="registerBtn" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-4">Register</button>
                                    </div>
                            </form>
                            <!--end form-->
                        </div>
