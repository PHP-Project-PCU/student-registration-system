            ...
            <div class="grid lg:grid-cols-12 grid-cols-1" id="reserve-form">
                <div class="lg:col-start-2 lg:col-span-10">
                    <div class="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 p-6">
                        <form action="" enctype="multipart/form-data" id="stdAdmissionForm">
                                ...
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="roll_num" id="roll_num" type="number"
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="xxxxxx" value="PaKaPaTa-">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                    ...
                                    <div class="text-start">
                                        <table class="table-fixed w-full" name="examTable" id="examTable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="exam_name0" name="exam_name"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                        <option>-</option>
                                                ...
                                                <td>
                                                    <select id="exam_major0" name="exam_major"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                        <option>-</option>
                                                        <option>CST</option>
                                                        <option>CS</option>
                                                ...
                                                <td>
                                                    <input id="exam_roll_num0" name="exam_roll_num" type="number"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                        placeholder="">
                                                </td>
                                                <td>
                                                    <input id="exam_year0" name="exam_year" type="number"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                        placeholder="">
                                                </td>
                                                <td>
                                                    <select id="exam_status0" name="exam_status"
                                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                        <option>-</option>
                                                        <option>အောင်</option>
                                                        <option>ရှုံး</option>
