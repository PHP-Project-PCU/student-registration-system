                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 p-6">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid lg:grid-cols-12 gap-6 pt-4">
                                ...
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="started_year" id="started_year" type="number" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="" min="2015" max="2050">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        <label for="student_name_my">အမည်(မြန်မာစာဖြင့်)</label>
                                        <input name="student_name_my" id="student_name_my" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="မောင်/မ">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="student_name_en" id="student_name_en" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="Mg / Ma...">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="student_ethnicity" id="student_ethnicity" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    ...
                                    <input name="student_religion" id="student_religion" type="text" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="student_birth_place">မွေးဖွားရာဇာတိ</label>
                                    <input name="student_birth_place" id="student_birth_place" type="text" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="student_nationality">နိုင်ငံခြားသား</label>
                                    <select id="student_nationality" name="student_nationality" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                ...
                                <div class="lg:col-span-4">
                                    <div class="text-start">
                                        ...
                                        <input name="student_dob" id="student_dob" type="date" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                ...
                                <<<<<<< HEAD <div class="bg-indigo-300 p-5 rounded-md lg:col-span-12 ">
                            ...
                            <div class="lg:col-span-6">
                                ...
                                <input name="father_nrc_photo_front" id="" type="file"
                                    class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                            </div>
                            <div class="lg:col-span-6">
                                <label for="father_nrc_photo_back">အဘမှတ်ပုံတင်(နောက်ဘက်)</label>
                                <input name="father_nrc_photo_back" id="" type="file"
                                    class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                            </div>
                            <div class="lg:col-span-6">
                                <label for="mother_nrc_photo_front">အမိမှတ်ပုံတင်(ရှေ့ဘက်)</label>
                                <input name="mother_nrc_photo_front" id="" type="file"
                                    class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                            </div>
                            <div class="lg:col-span-6">
                                <label for="mother_nrc_photo_back">အမိမှတ်ပုံတင်(နောက်ဘက်)</label>
                                <input name="mother_nrc_photo_back" id="" type="file"
                                    class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                            </div>
                            <div class="lg:col-span-6">
                            ...
                            <div class="lg:col-span-6">
                                ...
                                <input name="house_registratoin_photo_front" id="" type="file"
                                    class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                            </div>
                            <div class="lg:col-span-6">
                                <label for="house_registratoin_photo_back">အိမ်ထောင်စုစာရင်း(နောက်ဘက်)</label>
                                <input name="house_registratoin_photo_back" id="" type="file"
                                    class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                            </div>
                            <div class="lg:col-span-6">
                                                ...
                                                <div class="p-5">
                                                    ...
                                                    <div class="lg:col-span-4">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="student_phone_num" id="student_phone_num"
                                                    ...
                                                    <div class="lg:col-span-4">
                                                        ...
                                                        <select id="student_region" name="student_region" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                        </select>
                                                    </div>
                                                    <div class="lg:col-span-4">
                                                        <label for="student_township">&nbsp;</label>
                                                        <select id="student_township" name="student_township" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                        </select>
                                                    </div>
                                                    <div class="lg:col-span-4">
                                                        <label for="student_current_address">&nbsp;</label>
                                                        <input name="student_current_address"
                                                            id="student_current_address" type="text" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                    ...
                                                    <div class="lg:col-span-4">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="matriculation_roll_num"
                                                                id="matriculation_roll_num" type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="lg:col-span-4">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="matriculation_year" id="matriculation_year"
                                                                type="number" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-4">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="matriculation_exam_center"
                                                                id="matriculation_exam_center" required type="text"
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="bg-indigo-300 p-5 rounded-md lg:col-span-12 ">
                                                        <label for="subject"
                                                            class="font-semibold">အဘအုပ်ထိန်းသူ၏အချက်အလက်</label>
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            <label
                                                                for="student_fath_name_my">အမည်(မြန်မာစာဖြင့်)</label>
                                                            <input name="student_fath_name_my" id="student_fath_name_my"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            <label
                                                                for="student_fath_name_en">အမည်(အင်္ဂလိပ်စာဖြင့်)</label>
                                                            <input name="student_fath_name_en" id="student_fath_name_en"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="student_fath_ethnicity"
                                                                id="student_fath_ethnicity" type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        ...
                                                        <input name="student_fath_religion" id="student_fath_religion"
                                                            type="text" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                            placeholder="">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        ...
                                                        <input name="student_fath_birth_place"
                                                            id="student_fath_birth_place" type="text" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                            placeholder="">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label for="student_fath_nationality">နိုင်ငံခြားသား</label>
                                                        <select id="student_fath_nationality"
                                                            name="student_fath_nationality" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                            <option>တိုင်းရင်းသား</option>
                                                            <option>နိုင်ငံခြားသား</option>
                                                        </select>
                                                    ...
                                                    <div class="lg:col-span-3">
                                                        <label for="student_fath_nrc_code">နိုင်ငံသား
                                                            စိစစ်ရေးအမှတ်</label>
                                                    ...
                                                    <div class="lg:col-span-3">
                                                        ...
                                                        <input name="student_fath_nrc_num" id="student_fath_nrc_num"
                                                            type="number" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                            placeholder="xxxxxx">
                                                    </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="student_fath_job" id="student_fath_job"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="student_fath_phone_num"
                                                                id="student_fath_phone_num" type="number" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="Phone No. :">
                                                        </div>
                                                    </div>
                                                    <div class="lg:col-span-12">
                                                        <div class="text-start">
                                                            <label
                                                                for="student_fath_address">အဘအုပ်ထိန်းသူ၏လိပ်စာအပြည့်အစုံ</label>
                                                            <textarea name="student_fath_address"
                                                                id="student_fath_address" required
                                                    ...
                                                    <div class="bg-indigo-300 p-5 rounded-md lg:col-span-12 ">
                                                        <label for=""
                                                            class="font-semibold">အမိအုပ်ထိန်းသူ၏အချက်အလက်</label>
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            <label
                                                                for="student_moth_name_my">အမည်(မြန်မာစာဖြင့်)</label>
                                                            <input name="student_moth_name_my" id="student_moth_name_my"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            <label
                                                                for="student_moth_name_en">အမည်(အင်္ဂလိပ်စာဖြင့်)</label>
                                                            <input name="student_moth_name_en" id="student_moth_name_en"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="student_moth_ethnicity"
                                                                id="student_moth_ethnicity" type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        ...
                                                        <input name="student_moth_religion" id="student_moth_religion"
                                                            type="text" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                            placeholder="">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        ...
                                                        <input name="student_moth_birth_place"
                                                            id="student_moth_birth_place" type="text" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                            placeholder="">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label for="student_moth_nationality">နိုင်ငံခြားသား</label>
                                                        <select id="student_moth_nationality"
                                                            name="student_moth_nationality" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                            <option>တိုင်းရင်းသား</option>
                                                            <option>နိုင်ငံခြားသား</option>
                                                        </select>
                                                    ...
                                                    <div class="lg:col-span-3">
                                                        <label for="student_moth_nrc_code">နိုင်ငံသား
                                                            စိစစ်ရေးအမှတ်</label>
                                                        <select id="student_moth_nrc_code"
                                                            name="student_moth_nrc_num_code"
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                        </select>
                                                    </div>
                                                    <div class="lg:col-span-3">
                                                    ...
                                                    <div class="lg:col-span-3">
                                                        ...
                                                        <input name="student_moth_nrc_num" id="student_moth_nrc_num"
                                                            type="number" required
                                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                            placeholder="xxxxxx">
                                                    </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="student_moth_job" id="student_moth_job"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="student_moth_phone_num"
                                                                id="student_moth_phone_num" type="number" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="Phone No. :">
                                                        </div>
                                                    </div>
                                                    <div class="lg:col-span-12">
                                                        <div class="text-start">
                                                            <label
                                                                for="student_moth_address">အမိအုပ်ထိန်းသူ၏လိပ်စာအပြည့်အစုံ</label>
                                                            <textarea name="student_moth_address"
                                                                id="student_moth_address" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder=""></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="bg-indigo-300 p-5 rounded-md lg:col-span-12 ">
                                                        <label for=""
                                                            class="font-semibold">ကျောင်းနေရန်အထောက်အပံ့ပြုမည့်ပုဂ္ဂိုလ်</label>
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="guardian_relation" id="guardian_relation"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="guardian_address" id="guardian_address"
                                                                type="text" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <div class="text-start">
                                                            ...
                                                            <input name="guardian_phone_num" type="number" required
                                                                class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                                                placeholder="Phone No. :">
                                                        </div>
                                                    </div>
                                                    <div class="lg:col-span-12">
                                                        <div class="text-start">
                                                            <label
                                                                for="scholar">ပညာသင်ထောက်ပံ့ကြေးပေးရန်မေတ္တာရပ်ခံခြင်းပြု/မပြု</label>
                                                            <div class="mt-3 w-full py-2 px-3 h-10">
                                                                <input name="scholar" type="radio" value="1"> ပြု
                                                                <input name="scholar" type="radio" value="0" checked>
                                                                မပြု
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <label for="passport_photo">လိုင်စင်ဓာတ်ပုံ (1" x 1.25") ဆိုဒ် ၁
                                                            ပုံ (၆လ အတွင်း
                                                            ရိုက်ထားသောပုံ) </label>
                                                        <input name="passport_photo" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        ...
                                                        <input name="one_inch_photo" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="student_nrc_photo_front">ကျောင်းသားမှတ်ပုံတင်(ရှေ့ဘက်)</label>
                                                        <input name="student_nrc_photo_front" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="student_nrc_photo_back">ကျောင်းသားမှတ်ပုံတင်(နောက်ဘက်)</label>
                                                        <input name="student_nrc_photo_back" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="father_nrc_photo_front">အဘမှတ်ပုံတင်(ရှေ့ဘက်)</label>
                                                        <input name="father_nrc_photo_front" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="father_nrc_photo_back">အဘမှတ်ပုံတင်(နောက်ဘက်)</label>
                                                        <input name="father_nrc_photo_back" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="mother_nrc_photo_front">အမိမှတ်ပုံတင်(ရှေ့ဘက်)</label>
                                                        <input name="mother_nrc_photo_front" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="mother_nrc_photo_back">အမိမှတ်ပုံတင်(နောက်ဘက်)</label>
                                                        <input name="mother_nrc_photo_back" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="covid_photo">ကိုဗစ်ကာကွယ်ဆေးထိုးပြီးကြောင်းထောက်ခံချက်</label>
                                                        <input name="covid_photo" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label for="matriculation_certificate">၁၀
                                                            တန်းအောင်လက်မှတ်</label>
                                                        <input name="matriculation_certificate" id="" type="file"
                                                            required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    ...
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="house_registratoin_photo_front">အိမ်ထောင်စုစာရင်း(ရှေ့ဘက်)</label>
                                                        <input name="house_registratoin_photo_front" id="" type="file"
                                                            required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label
                                                            for="house_registratoin_photo_back">အိမ်ထောင်စုစာရင်း(နောက်ဘက်)</label>
                                                        <input name="house_registratoin_photo_back" id="" type="file"
                                                            required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label for="quarter_approved_letter">ရပ်ကွက်ထောက်ခံစာ</label>
                                                        <input name="quarter_approved_letter" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    <div class="lg:col-span-6">
                                                        <label for="police_approved_letter">ရဲစခန်းထောက်ခံစာ</label>
                                                        <input name="police_approved_letter" id="" type="file" required
                                                            class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                                    </div>
                                                    ...
                                                    <div class="lg:col-span-12">
                                                        ...
                                                        <button type="submit" id="submit" name="send"
                                                            class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-4">Show
                                                            preview</button>
                                                    </div>
                                                    <<<<<<< HEAD <button id="submit" name="preview"
                                                        class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-4">
                                                        Show
                                                        preview</button>
                                                </div>
                        </form>
