...
$fees = $paymentController->getPaymentsBySemesterId(1);
                            ...
                            <div class="grid lg:grid-cols-12 gap-6 pt-4">
                                ...
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="passing_year" id="passing_year" type="number" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                            ...
                            <div class="grid lg:grid-cols-12 gap-6 pt-4">
                                ...
                                <div class="lg:col-span-4">
                                    <div class="text-start">
                                        ...
                                        <input name="student_phone_num" id="student_phone_num" type="number" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <select id="student_nrc_code" name="student_nrc_code" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-3">
                                    <label for="student_nrc_name">&nbsp;</label>
                                    <select id="student_nrc_name" name="student_nrc_name" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-3">
                                    <label for="studen_nrc_type">&nbsp;</label>
                                    <select id="studen_nrc_type" name="student_nrc_type" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <input name="student_nrc_num" id="student_nrc_num" type="number" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="xxxxxx">
                                </div>
                                <div class="lg:col-span-4">
                                ...
                                <div class="lg:col-span-4">
                                    <div class="text-start">
                                        ...
                                        <input name="matriculation_roll_num" id="matriculation_roll_num" type="text"
                                            ...
                                            dark:focus:border-indigo-600 focus:ring-0" placeholder="" required>
                                    </div>
                                </div>
                                <div class="lg:col-span-4">
                                    <div class="text-start">
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <input name="student_fath_religion" id="student_fath_religion" type="text" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="" required>
                                </div>
                                <div class="lg:col-span-6">
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <select id="student_fath_nationality" name="student_fath_nationality" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                        <option value="တိုင်းရင်းသား">တိုင်းရင်းသား</option>
                                        <option value="နိုင်ငံခြားသား">နိုင်ငံခြားသား</option>
                                    </select>
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <select id="student_fath_nrc_code" name="student_fath_nrc_code" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-3">
                                    <label for="student_fath_nrc_name">&nbsp;</label>
                                    <select id="student_fath_nrc_name" name="student_fath_nrc_name" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-3">
                                    <label for="student_fath_nrc_type">&nbsp;</label>
                                    <select id="student_fath_nrc_type" name="student_fath_nrc_type" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                        <option value="(သ)">(သ)</option>
                                        <option value="(သီ)">(သီ)</option>
                                        <option value="(နိုင်)">(နိုင်)</option>
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <input name="student_fath_nrc_num" id="student_fath_nrc_num" type="number" required
                                        required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="xxxxxx">
                                </div>
                                <div class="lg:col-span-6">
                                    ...
                                    <select id="student_fath_region" name="student_fath_region" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="student_fath_township">&nbsp;</label>
                                    <select id="student_fath_township" name="student_fath_township" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="student_fath_job" id="student_fath_job" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-12">
                                    <div class="text-start">
                                        ...
                                        <textarea name="student_fath_address" id="student_fath_address" required
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <input name="student_moth_religion" id="student_moth_religion" type="text" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="">
                                </div>
                                <div class="lg:col-span-6">
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <select id="student_moth_nationality" name="student_moth_nationality" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                        <option value="တိုင်းရင်းသား">တိုင်းရင်းသား</option>
                                        <option value="နိုင်ငံခြားသား">နိုင်ငံခြားသား</option>
                                    </select>
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <select id="student_moth_nrc_code" name="student_moth_nrc_code" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-3">
                                    <label for="student_moth_nrc_name">&nbsp;</label>
                                    <select id="student_moth_nrc_name" name="student_moth_nrc_name" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-3">
                                    <label for="student_moth_nrc_type">&nbsp;</label>
                                    <select id="student_moth_nrc_type" name="student_moth_nrc_type" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                        <option value="(သ)">(သ)</option>
                                        <option value="(သီ)">(သီ)</option>
                                        <option value="(နိုင်)">(နိုင်)</option>
                                ...
                                <div class="lg:col-span-3">
                                    ...
                                    <input name="student_moth_nrc_num" id="student_moth_nrc_num" type="number" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                        placeholder="xxxxxx">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="student_moth_region">နေရပ်လိပ်စာ အပြည့်အစုံ</label>
                                    <select id="student_moth_region" name="student_moth_region" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="student_moth_township">&nbsp;</label>
                                    <select id="student_moth_township" name="student_moth_township" required
                                        class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                    </select>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="student_moth_job" id="student_moth_job" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-12">
                                    <div class="text-start">
                                        ...
                                        <textarea name="student_moth_address" id="student_moth_address" required
                                            class="form-input mt-3 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder=""></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="guardian_name" id="guardian_name" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="guardian_relation" id="guardian_relation" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="guardian_job" id="guardian_job" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="lg:col-span-6">
                                    <div class="text-start">
                                        ...
                                        <input name="guardian_address" id="guardian_address" type="text" required
                                            class="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"
                                            placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <input name="fath_nrc_photo_front" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="fath_nrc_photo_back">အဘမှတ်ပုံတင်(နောက်ဘက်)</label>
                                    <input name="fath_nrc_photo_back" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="moth_nrc_photo_front">အမိမှတ်ပုံတင်(ရှေ့ဘက်)</label>
                                    <input name="moth_nrc_photo_front" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="moth_nrc_photo_back">အမိမှတ်ပုံတင်(နောက်ဘက်)</label>
                                    <input name="moth_nrc_photo_back" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                ...
                                <div class="lg:col-span-6">
                                    ...
                                    <input name="matriculation_certificate" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="matriculation_mark_photo">၁၀ တန်းအမှတ်စာရင်း</label>
                                    <input name="matriculation_mark_photo" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="house_registration_photo_front">အိမ်ထောင်စုစာရင်း(ရှေ့ဘက်)</label>
                                    <input name="house_registration_photo_front" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                    <label for="house_registration_photo_back">အိမ်ထောင်စုစာရင်း(နောက်ဘက်)</label>
                                    <input name="house_registration_photo_back" id="" type="file" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer">
                                </div>
                                <div class="lg:col-span-6">
                                ...
                                <div class="lg:col-span-12">
                                    ...
                                    <input name="payment_screenshot" required
                                        class=" w-full mt-3 cursor-pointer bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-lg outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 file:bg-indigo-600 file:text-white file:border-none file:rounded-l-lg file:py-2 file:px-4 file:mr-3 file:cursor-pointer"
                                        id="" type="file">
                                </div>
                                <div class="lg:col-span-4">
