            ...
            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                ...
                <div class="lg:col-span-8 md:col-span-7">
                        ...
                        <div class="" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="mt-6">
                                ...
                                <p class="text-slate-400 mb-2">
                                    <ul class="disc">
                                <li> It is envisaged that Department of Physics will become one of the highly prestigious
                                departments in University of Computer Studies (Pyay), in teaching and committing to 
                                impart quality education both in theoretical as well as experimental physics with 
                                founded by vibrant basic concepts to enhance in production of students with highly-qualified
                                 specialists and professionals in their respective fields.</li>
                                    </ul>
                                </p><br>
                                ...
                                <ul class="disc">
                                    <li>have understood high conceptual background and knowledge in Physics;</li>
                                    <li>can think rationally approach and solve problems systematically;</li>
                                    <li>can provide creative thinking for high quality education in Information Technology ( IT).</li>
                                </ul></ul>
                                </p>
                                <br>
                                ...
                                <p class="text-slate-400 mb-2">
                                   <ul class="disc">
                                    <li>To support the requirements of basic knowledge and skills in physics for students.</li>
                                    <li>To motivate a sense of ethical responsibilities among students.</li>
                                    <li>To raise the percentage class attendance by escalating their interest in subjects.</li>
                                    <li>To minimize the percentage failure in exams by making routine practice tests</li>
                                   </ul>
                                </p>
                    ...
                    <div class="hidden " id="settings" role="tabpanel" aria-labelledby="settings-tab">
                        ...
                        <div class="mt-6">
                            <h5 class="text-lg font-semibold mb-4">Department of Physics</h5>
