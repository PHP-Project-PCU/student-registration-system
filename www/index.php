...
<body class="font-nunito text-base text-black dark:text-white dark:bg-slate-900 scroll-smooth">
    ...
    <section class="relative overflow-hidden py-16">
        ...
        <div class="container relative z-2">
            <div class="grid grid-cols-1 md:mt-44 mt-32 text-center py-4">
                <div class="wow">
                    <h4 class="text-white font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 animate__animated animate__flipInX">University of Computer Studies, Pyay</h4>
                    ...
                    <p class="text-white text-lg max-w-xl mx-auto animate__animated animate__jello">ကွန်ပျူတာတက္ကသိုလ်(ပြည်)</p>

                    <div class="mt-6">
                        <a href="./admission/index.php" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md animate__animated animate__flipInX">Student Admission</a>
                    </div>
                </div>
            </div><!--end grid-->
        </div><!--end container-->
    ...
    <div class="container relative md:mt-24 mt-16">
        <div class="grid grid-cols-1 pb-8 text-center">
            ...
            <p class="text-slate-400 max-w-xl mx-auto">To give the students a higher standard education. Give better education service,</p>
            <p class="text-slate-400 max-w-xl mx-auto">To provide human resources and enhance the development of the country.</p>
        </div><!--end grid-->
    </div>
                                ...
                                <div class="grid md:grid-cols-2 grid-cols-1 items-center">
                                    <div class="mt-8">
                                        <div class="section-title text-md-start">
                                            ...
                                            <h3 class="md:text-3xl text-2xl md:leading-normal leading-normal font-semibold text-white mt-2">“ပညာ၀ေဆာ၊ သီရိခေတ္တရာ” </h3>
                                        </div>
                                    </div>

                                    <div class="mt-8">
                                        <div class="section-title text-md-start">
                                            <span class="text-white/50 max-w-xl mx-auto mb-2">University of Computer Studies (Pyay) is government funded university located in Pyay, Bago Region with an emphasis is on computer engineering at the undergraduate and graduate levels. Founded in 2004…</span>
