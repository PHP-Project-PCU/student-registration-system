                        ...
                        <div class="" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="mt-6">
                                ...
                                <p class="text-slate-400">
                                    <ul class="disc">
                                <li>An essential role of our faculty is to systematically educate and train the students of high calibre to become software engineers, 
                                designers and developers with the ability to solve complex problems. The faculty offers a wide range of academic disciplines of Bachelor’s degree 
                                with the established professional academic staff and well-equipped modern facilities.  </li>
                                    </ul>
                                </p>
                                <h5 class="text-lg font-semibold mt-5 mb-4">Mission</h5>
                                <p class="text-slate-400">
                                    <ul class="disc">

                                <li>Faculty of Information Science, University of Computer Studies, Pyay is a bearer of university education in the fields of Software Engineering.</li>
                                <li>Database Management System, Management Information System, Data Mining, System Analysis and Design, Object-Oriented Analysis and Design and Programming Logic.</li> 
                                <li>The faculty creates conditions favoring the increase in the level of education and knowledge via teaching and quality technical background that provide 
                                the possibilities for both professional and personal development of all students.</li> 
                                    </ul>
                                </p>
                                <h5 class="text-lg font-semibold mt-5 mb-4">Objectives</h5>
                                <p class="text-slate-400">
                                   <ul class="disc">
                                    <li>To provide a curriculum that prepares professionals responsive to the field</li>
                                    <li>To enrich the curriculum through partnerships with other departments and university entities.</li>
                                    <li>To provide internships and other connections with the local community and beyond.</li>
                                    <li>To conduct an ongoing systematic review and evaluation of the program.</li>
                                   </ul></p>
