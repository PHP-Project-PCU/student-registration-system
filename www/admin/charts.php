...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Charts - UCSPYAY ADMIN Dashboard</title>
    <link
    ...
    <script
      src="http://ucsp.edu/utils/assets/js/alpine.min.js"
      defer
    ></script>
    <script src="http://ucsp.edu/utils/assets/js/init-alpine.js"></script>
    <link
      rel="stylesheet"
      href="http://ucsp.edu/utils/assets/css/Chart.min.css"
    />
    <script
      src="http://ucsp.edu/utils/assets/js/Chart.min.js"
      defer
    ></script>
    ...
    <script src="http://ucsp.edu/utils/assets/js/charts-bars.js" defer></script>
  </head>
  <body>
    <div
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <p class="mb-8 text-gray-600 dark:text-gray-400">
              ...
              provide a description for your charts in php. See source code for
              examples.
            </p>
