            ...
            <div class="overflow-y-auto md:pt-16 px-4 pb-4 h-full">
                ...
                <div class="p-4">
                    <div class="flex justify-start pb-4">
                        <button onclick="window.location.href='/admission/second-year'"
                                ...
                                <table class="w-full table-fixed">
                                    <tr>
                                        ...
                                        <td class="text-indigo-600">
                                            <?php if (($studentData['student']['year']) == 2) echo "ဒုတိယနှစ်"; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">အထူးပြုဘာသာ</td>
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['major']); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">ခုံအမှတ်</td>
                                        <td class="text-indigo-600">
                                            <?= 'PaKaPaTa - ' .  htmlspecialchars($studentData['student']['roll_num']); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['started_year']); ?></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <table class="w-full ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['student_name_my']); ?></td>
                                        <td class="text-indigo-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['student_name_en']); ?></td>
                                        <td class="text-indigo-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['student_ethnicity']); ?></td>
                                        <td class="text-indigo-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['student_religion']); ?></td>
                                        <td class="text-indigo-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['student_nrc']); ?></td>
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['parent']['student_fath_nrc']); ?></td>
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['parent']['student_moth_nrc']); ?></td>
                                    ...
                                    <tr>
                                        <td class="">ခုနှစ်</td>
                                        <td class="text-indigo-600">
                                            <?= htmlspecialchars($studentData['student']['matriculation_year']); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="text-start text-indigo-600">
                                            <?= htmlspecialchars($studentData['guardian']['guardian_name']); ?></td>

                                    </tr>
                                    <tr>
                                        <td colspan="1" class="text-start">(ခ) ဆွေမျိုးတော်စပ်ပုံ</td>
                                        <td colspan="2" class="text-start text-indigo-600">
                                            <?= htmlspecialchars($studentData['guardian']['guardian_relation']); ?></td>

                                    </tr>
                                    <tr>
                                        <td colspan="1" class="text-start">(ဂ) အလုပ်အကိုင်</td>
                                        <td colspan="2" class="text-start text-indigo-600">
                                            <?= htmlspecialchars($studentData['guardian']['guardian_job']); ?></td>

                                    </tr>
                                    <tr>
                                        <td colspan="1" class="text-start">(ဃ) ဆက်သွယ်ရန်လိပ်စာ</td>
                                        <td colspan="2" class="text-start text-indigo-600">
                                            <?= htmlspecialchars($studentData['guardian']['guardian_address']); ?></td>
