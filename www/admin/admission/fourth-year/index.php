...
$freshers = $studentAdmissionController->getAllStudentsByStatusAndYear($status, 4, $selectedYear, $page, $limit);
$getStudentsTotalRows = $studentAdmissionController->getTotalRows(4, $status); // 3 for third year
                ...
                <div class="p-4">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <h4 class="m-4 text-2xl font-semibold text-gray-800 dark:text-gray-300">
                            စတုတ္ထနှစ်ဝင်ခွင့်လျှောက်ထားသူများ
                        </h4>
