    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <div class=" flex flex-col flex-1 w-full">
            ...
            <div class="p-4">
                ...
                <div class="">
                    <div class="w-full mt-8 gap-[30px]">
                        <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden wow animate__animated animate__fadeInUp"
                            ...
                            <div class="content p-6">
                                <div>
                                    <h3 href="view.php?id=<?= $post['id'] ?>"
                                        class=" title h5 text-2xl font-medium "><?= $post['title'] ?></h3>
                                    <p class="text-slate-300 text-md   mt-3"><?= $post['description'] ?> </p>
                                </div>

                                <div class="img">
                                    <?php foreach ($post['images'] as $key => $image): ?>
                                        <?php if ($key != 0): ?>
                                            <img src="<?= getRelativePath($image) ?>" alt="" width="200">
                                        <?php endif ?>
                                    <?php endforeach ?>
                                </div>
